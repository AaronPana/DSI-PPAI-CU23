...
# # Luego importamos sismografo_data localmente para romper el círculo
# from data.sismografos import sismografo_data
# # Ahora asignamos los sismografos correctos a cada SerieTemporal
# SerieTemporal0.sismografo = sismografo_data[0]
# SerieTemporal1.sismografo = sismografo_data[1]
# SerieTemporal2.sismografo = sismografo_data[2]
# SerieTemporal3.sismografo = sismografo_data[1]
# SerieTemporal4.sismografo = sismografo_data[1]
# SerieTemporal5.sismografo = sismografo_data[1]
